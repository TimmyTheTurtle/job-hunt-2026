...
- Historical planning notes still exist in [job-search-tips.md](job-search-tips.md), but the canonical strategy now lives in [current_strategy.md](current_strategy.md).
